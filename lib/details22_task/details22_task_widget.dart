...
import 'details22_task_model.dart';
export 'details22_task_model.dart';

class Details22TaskWidget extends StatefulWidget {
  const Details22TaskWidget({super.key});

  @override
  State<Details22TaskWidget> createState() => _Details22TaskWidgetState();
}

class _Details22TaskWidgetState extends State<Details22TaskWidget>
    with TickerProviderStateMixin {
  late Details22TaskModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => Details22TaskModel());
