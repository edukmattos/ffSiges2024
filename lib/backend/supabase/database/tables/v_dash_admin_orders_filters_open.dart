...
class VDashAdminOrdersFiltersOpenTable
    extends SupabaseTable<VDashAdminOrdersFiltersOpenRow> {
  @override
  String get tableName => 'v_dash_admin_orders_filters_open';

  @override
  VDashAdminOrdersFiltersOpenRow createRow(Map<String, dynamic> data) =>
      VDashAdminOrdersFiltersOpenRow(data);
}

class VDashAdminOrdersFiltersOpenRow extends SupabaseDataRow {
  VDashAdminOrdersFiltersOpenRow(super.data);

  @override
  SupabaseTable get table => VDashAdminOrdersFiltersOpenTable();
