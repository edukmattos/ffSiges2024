...
class VDashAdminUsersTeamsContractsFiltersTable
    extends SupabaseTable<VDashAdminUsersTeamsContractsFiltersRow> {
  @override
  String get tableName => 'v_dash_admin_users_teams_contracts_filters';

  @override
  VDashAdminUsersTeamsContractsFiltersRow createRow(
          Map<String, dynamic> data) =>
      VDashAdminUsersTeamsContractsFiltersRow(data);
}

class VDashAdminUsersTeamsContractsFiltersRow extends SupabaseDataRow {
  VDashAdminUsersTeamsContractsFiltersRow(super.data);

  @override
  SupabaseTable get table => VDashAdminUsersTeamsContractsFiltersTable();
