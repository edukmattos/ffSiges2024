...
class CwOrderVisitServiceAmount extends StatefulWidget {
  const CwOrderVisitServiceAmount({
    Key? key,
    this.width,
    this.height,
    this.value,
  ...
  @override
  _CwOrderVisitServiceAmountState createState() =>
      _CwOrderVisitServiceAmountState();
}

class _CwOrderVisitServiceAmountState extends State<CwOrderVisitServiceAmount> {
  @override
  ...
  void updateValues(String text) {
    ...
    FFAppState().asCwOrderVisitServiceAmountFormatted =
        text; // Altere para o nome do seu Appstate de valor formatado(string)
    FFAppState().asCwOrderVisitServiceAmountDouble =
