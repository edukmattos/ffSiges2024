...
class CwOVServiceDiscount extends StatefulWidget {
  const CwOVServiceDiscount({
    Key? key,
    this.width,
    this.height,
    this.value,
  ...
  @override
  _CwOVServiceDiscountState createState() => _CwOVServiceDiscountState();
}

class _CwOVServiceDiscountState extends State<CwOVServiceDiscount> {
  @override
  ...
  void updateValues(String text) {
    ...
    FFAppState().asCwOVServiceDiscountFormatted =
        text; // Altere para o nome do seu Appstate de valor formatado(string)
    FFAppState().asCwOVServiceDiscountDouble =
