...
class CwOVServiceAmount extends StatefulWidget {
  const CwOVServiceAmount({
    Key? key,
    this.width,
    this.height,
    this.value,
  ...
  @override
  _CwOVServiceAmountState createState() => _CwOVServiceAmountState();
}

class _CwOVServiceAmountState extends State<CwOVServiceAmount> {
  @override
  ...
  void updateValues(String text) {
    ...
    FFAppState().asCwOVServiceAmountFormatted =
        text; // Altere para o nome do seu Appstate de valor formatado(string)
    FFAppState().asCwOVServiceAmountDouble =
