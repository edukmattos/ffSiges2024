...
import 'pg_orders_visits_services_search_model.dart';
export 'pg_orders_visits_services_search_model.dart';

class PgOrdersVisitsServicesSearchWidget extends StatefulWidget {
  const PgOrdersVisitsServicesSearchWidget({super.key});

  @override
  State<PgOrdersVisitsServicesSearchWidget> createState() =>
      _PgOrdersVisitsServicesSearchWidgetState();
}

class _PgOrdersVisitsServicesSearchWidgetState
    extends State<PgOrdersVisitsServicesSearchWidget>
    with TickerProviderStateMixin {
  late PgOrdersVisitsServicesSearchModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => PgOrdersVisitsServicesSearchModel());
