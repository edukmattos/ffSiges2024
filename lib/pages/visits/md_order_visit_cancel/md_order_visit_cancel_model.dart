...
import 'md_order_visit_cancel_widget.dart' show MdOrderVisitCancelWidget;
import 'package:flutter/material.dart';

class MdOrderVisitCancelModel
    extends FlutterFlowModel<MdOrderVisitCancelWidget> {
  ...
  // Stores action output result for [Backend Call - API (apiDtUsersByVisitId)] action in mdOrderVisitCancel widget.
