...
import 'md_order_visit_cancel_model.dart';
export 'md_order_visit_cancel_model.dart';

class MdOrderVisitCancelWidget extends StatefulWidget {
  const MdOrderVisitCancelWidget({
    super.key,
  ...
  @override
  State<MdOrderVisitCancelWidget> createState() =>
      _MdOrderVisitCancelWidgetState();
}

class _MdOrderVisitCancelWidgetState extends State<MdOrderVisitCancelWidget>
    with TickerProviderStateMixin {
  late MdOrderVisitCancelModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => MdOrderVisitCancelModel());
