...
import 'pg_o_v_asset_moving_model.dart';
export 'pg_o_v_asset_moving_model.dart';

class PgOVAssetMovingWidget extends StatefulWidget {
  const PgOVAssetMovingWidget({super.key});

  @override
  State<PgOVAssetMovingWidget> createState() => _PgOVAssetMovingWidgetState();
}

class _PgOVAssetMovingWidgetState extends State<PgOVAssetMovingWidget>
    with TickerProviderStateMixin {
  late PgOVAssetMovingModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => PgOVAssetMovingModel());
