  ...
  Widget build(BuildContext context) {
    ...
    return FutureBuilder<List<VUnitsRow>>(
      ...
      builder: (context, snapshot) {
        ...
        List<VUnitsRow> containerVUnitsRowList = snapshot.data!;
        final containerVUnitsRow = containerVUnitsRowList.isNotEmpty
            ? containerVUnitsRowList.first
            : null;
        return Container(
              ...
              children: [
                ...
                Row(
                  ...
                  children: [
                    Expanded(
                      child: Text(
                        '${containerVUnitsRow?.systemsParentDescription} / ${containerVUnitsRow?.systemsChildDescription} / ${valueOrDefault<String>(
                    ...
                    Align(
                      ...
                      child: FlutterFlowIconButton(
                        ...
                        onPressed: () async {
                          if (isWeb) {
                            await launchURL(
                                'https://www.google.com/maps?q=${'${containerVUnitsRow?.latitude?.toString()},${containerVUnitsRow?.longitude?.toString()}'}');
                          } else {
                            await launchMap(
                              location: functions.cfConvToLatLng(
                                  containerVUnitsRow!.latitude!,
                                  containerVUnitsRow.longitude!),
                              title: containerVUnitsRow.descriptionFull!,
                            );
                          }
                        },
                      ).animateOnPageLoad(
