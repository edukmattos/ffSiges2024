...
import 'cp_asset_show_bottom_nav_bar_copy_model.dart';
export 'cp_asset_show_bottom_nav_bar_copy_model.dart';

class CpAssetShowBottomNavBarCopyWidget extends StatefulWidget {
  const CpAssetShowBottomNavBarCopyWidget({super.key});

  @override
  State<CpAssetShowBottomNavBarCopyWidget> createState() =>
      _CpAssetShowBottomNavBarCopyWidgetState();
}

class _CpAssetShowBottomNavBarCopyWidgetState
    extends State<CpAssetShowBottomNavBarCopyWidget> {
  late CpAssetShowBottomNavBarCopyModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => CpAssetShowBottomNavBarCopyModel());
