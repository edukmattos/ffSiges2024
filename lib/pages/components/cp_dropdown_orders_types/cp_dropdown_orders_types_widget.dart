...
class CpDropdownOrdersTypesWidget extends StatefulWidget {
  ...
  @override
  State<CpDropdownOrdersTypesWidget> createState() =>
      _CpDropdownOrdersTypesWidgetState();
}

class _CpDropdownOrdersTypesWidgetState
    extends State<CpDropdownOrdersTypesWidget> {
  late CpDropdownOrdersTypesModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => CpDropdownOrdersTypesModel());
  ...
  Widget build(BuildContext context) {
    ...
    return FutureBuilder<ApiCallResponse>(
      ...
      builder: (context, snapshot) {
        ...
        final dropdownOrdersTypesOrdersTypesByDepartmentResponse =
            snapshot.data!;
        return FlutterFlowDropDown<int>(
          ...
          options:
              List<int>.from(ApiOrdersTypesGroup.ordersTypesByDepartmentCall
                  .id(
                    dropdownOrdersTypesOrdersTypesByDepartmentResponse.jsonBody,
                  )!
                  .cast<int>()),
          optionLabels: ApiOrdersTypesGroup.ordersTypesByDepartmentCall
              ...
              .toList(),
          onChanged: (val) =>
              setState(() => _model.dropdownOrdersTypesValue = val),
