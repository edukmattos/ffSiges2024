                ...
                children: [
                    ...
                    child: ListView(
                      ...
                      children: [
                        FutureBuilder<List<VOrdersCountByParentOpenRow>>(
                          future:
                              VOrdersCountByParentOpenTable().querySingleRow(
                            queryFn: (q) => q.eq(
                              'parentId',
                              widget.orderId,
                            ),
                          ...
                          builder: (context, snapshot) {
                            ...
                            return Container(
                              decoration: const BoxDecoration(),
                              child: Visibility(
                                visible: containerVOrdersCountByParentOpenRow
                                        ?.counterStatus !=
                                    null,
                                child: Container(
                                  height: 80.0,
                  ...
                  Expanded(
                    child: Container(
                      ...
                      child: Builder(
                        builder: (context) {
                          if (_model.lpsvListViewOptions == 'ordersScheduled') {
                                ...
                                children: [
                                  FutureBuilder<List<VOrdersRow>>(
                                    ...
                                    builder: (context, snapshot) {
                                      ...
                                      List<VOrdersRow> listViewVOrdersRowList =
                                          snapshot.data!;
                                      return ListView.separated(
                                        ...
                                        itemBuilder: (context, listViewIndex) {
                                          ...
                                          return InkWell(
                                            ...
                                            child: CpOrderCardShowParentWidget(
                                              key: Key(
                                                  'Keydi0_${listViewIndex}_of_${listViewVOrdersRowList.length}'),
                                              orderId: listViewVOrdersRow.id!,
                                            ),
                                          );
                                        },
                                      );
                                      ...
                                      return ListView.separated(
                                        ...
                                        itemBuilder: (context, listViewIndex) {
                                          ...
                                          return InkWell(
                                            ...
                                            child: CpOrderCardShowParentWidget(
                                              key: Key(
                                                  'Keyylc_${listViewIndex}_of_${listViewVOrdersRowList.length}'),
                                              orderId: listViewVOrdersRow.id!,
                                            ),
                                          );
                                        },
                                      ...
                                      return ListView.separated(
                                        ...
                                        itemBuilder: (context, listViewIndex) {
                                          ...
                                          return InkWell(
                                            ...
                                            child: CpOrderCardShowParentWidget(
                                              key: Key(
                                                  'Keyhmd_${listViewIndex}_of_${listViewVOrdersRowList.length}'),
                                              orderId: listViewVOrdersRow.id!,
                                            ),
                                          );
                                        },
