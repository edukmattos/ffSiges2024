...
import 'pg_o_new_model.dart';
export 'pg_o_new_model.dart';

class PgONewWidget extends StatefulWidget {
  const PgONewWidget({
    super.key,
    int? orderParentId,
  ...
  @override
  State<PgONewWidget> createState() => _PgONewWidgetState();
}

class _PgONewWidgetState extends State<PgONewWidget>
    with TickerProviderStateMixin {
  late PgONewModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => PgONewModel());
                            ...
                            children: [
                              Column(
                                ...
                                children: [
                                  ...
                                  wrapWithModel(
                                    model: _model.cpInputTexMultilineModel,
                                    updateCallback: () => setState(() {}),
                                    child: CpInputTexMultilineWidget(
                                      initialValue: containerVOrdersRow
                                          ?.requestedServices,
                                      readOnly: false,
                                    ),
                                  ),
                                ...
                                children: [
                                  ...
                                  wrapWithModel(
                                    ...
                                    child: CpDropdownAssetsTagsWidget(
                                      initialValue:
                                          containerVOrdersRow?.assetTagId,
                                    ),
                                  ),
                                ],
                              ),
                                ...
                                children: [
                                  ...
                                  wrapWithModel(
                                    ...
                                    child: CpDropdownOrdersTypesWidget(
                                      initialValue: containerVOrdersRow?.typeId,
                                    ),
                                  ),
                                ],
                              ),
                              Column(
                                ...
                                children: [
                                  ...
                                  wrapWithModel(
                                    model:
                                        _model.cpDropdownOrdersTypesSubsModel,
                                    updateCallback: () => setState(() {}),
                                    child: const CpDropdownOrdersTypesSubsWidget(),
                                  ),
                                ],
                              ),
                              Align(
                                  ...
                                  children: [
                                    ...
                                    Align(
                                      ...
                                      child: FutureBuilder<
                                        ...
                                        future:
                                            OrdersPrioritiesTable().queryRows(
                              ...
                              Column(
                                ...
                                children: [
                                  ...
                                  Padding(
                                    ...
                                    child: wrapWithModel(
                                      model:
                                          _model.cpDropdownOrdersContractsModel,
                                      updateCallback: () => setState(() {}),
                                      child: const CpDropdownOrdersContractsWidget(),
                                    ),
                                  ),
                                ],
                              ),
                              Align(
                                ...
                                child: FFButtonWidget(
                                  onPressed: () async {
                                      ...
                                      await showDialog(
                                        ...
                                        builder: (alertDialogContext) {
                                          return AlertDialog(
                                            ...
                                            content: const Text('Informe o Setor.'),
                                            actions: [
                                              TextButton(
                                    ...
                                    if (_model.cpDropdownOrdersTypesSubsModel
                                      ...
                                      if ((_model
                                        ...
                                        _model.resOrderAdded =
                                          ...
                                          'typeSubId': _model
                                              ...
                                              .dropdownOrdersTypesSubsValue,
                                          'unitId': containerVOrdersRow?.unitId,
                                          'systemParentId': containerVOrdersRow
                                              ?.systemParentId,
                                          'systemId':
                                              containerVOrdersRow?.systemId,
                                          'unitTypeParentId':
                                              containerVOrdersRow
                                                  ?.unitTypeParentId,
                                          'unitTypeId':
                                              containerVOrdersRow?.unitTypeId,
                                          'requesterName': FFAppState()
                                              .asUserCurrent
                                              .nameShort,
                                          'requesterTeamId':
                                          ...
                                          'requestedServices': _model
                                              ...
                                              .text,
                                          'year': containerVOrdersRow?.year,
                                          'orderMask':
                                              '${containerVOrdersRow?.counterParent?.toString()}.${_model.lcsvOrderChildCounter?.toString()}.${containerVOrdersRow?.year?.toString()}',
                                          'requesterDate':
                                              supaSerialize<DateTime>(
                                                  getCurrentTimestamp),
                                          'statusId': 2,
                                          ...
                                          'priorityId':
                                              _model.resAbOrderPriorityId,
                                          'unitLatitude':
                                              containerVOrdersRow?.unitLatitude,
                                          'unitLongitude': containerVOrdersRow
                                              ?.unitLongitude,
                                          'counterParent': containerVOrdersRow
                                              ?.counterParent,
                                          'counterChild':
                                              _model.lcsvOrderChildCounter,
                                          'assetTagId': _model
                                        ...
                                        await action_blocks.abOPEvents(
                                          context,
                                          abOrderParentId: widget.orderParentId,
                                          abTitle:
