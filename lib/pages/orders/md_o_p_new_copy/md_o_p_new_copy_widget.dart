...
import 'md_o_p_new_copy_model.dart';
export 'md_o_p_new_copy_model.dart';

class MdOPNewCopyWidget extends StatefulWidget {
  const MdOPNewCopyWidget({
    super.key,
  ...
  @override
  State<MdOPNewCopyWidget> createState() => _MdOPNewCopyWidgetState();
}

class _MdOPNewCopyWidgetState extends State<MdOPNewCopyWidget>
    with TickerProviderStateMixin {
  late MdOPNewCopyModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => MdOPNewCopyModel());
