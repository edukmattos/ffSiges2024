...
import 'cp_order_parent_unit_show_model.dart';
export 'cp_order_parent_unit_show_model.dart';

class CpOrderParentUnitShowWidget extends StatefulWidget {
  const CpOrderParentUnitShowWidget({
    super.key,
  ...
  @override
  State<CpOrderParentUnitShowWidget> createState() =>
      _CpOrderParentUnitShowWidgetState();
}

class _CpOrderParentUnitShowWidgetState
    extends State<CpOrderParentUnitShowWidget> with TickerProviderStateMixin {
  late CpOrderParentUnitShowModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => CpOrderParentUnitShowModel());
