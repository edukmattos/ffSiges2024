...
import 'cp_order_card_show_parent_model.dart';
export 'cp_order_card_show_parent_model.dart';

class CpOrderCardShowParentWidget extends StatefulWidget {
  const CpOrderCardShowParentWidget({
    super.key,
  ...
  @override
  State<CpOrderCardShowParentWidget> createState() =>
      _CpOrderCardShowParentWidgetState();
}

class _CpOrderCardShowParentWidgetState
    extends State<CpOrderCardShowParentWidget> with TickerProviderStateMixin {
  late CpOrderCardShowParentModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => CpOrderCardShowParentModel());
