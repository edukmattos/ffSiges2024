...
import 'pg_o_p_new_model.dart';
export 'pg_o_p_new_model.dart';

class PgOPNewWidget extends StatefulWidget {
  const PgOPNewWidget({super.key});

  @override
  State<PgOPNewWidget> createState() => _PgOPNewWidgetState();
}

class _PgOPNewWidgetState extends State<PgOPNewWidget>
    with TickerProviderStateMixin {
  late PgOPNewModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => PgOPNewModel());
