...
import 'md_o_new_copy_model.dart';
export 'md_o_new_copy_model.dart';

class MdONewCopyWidget extends StatefulWidget {
  const MdONewCopyWidget({
    super.key,
  ...
  @override
  State<MdONewCopyWidget> createState() => _MdONewCopyWidgetState();
}

class _MdONewCopyWidgetState extends State<MdONewCopyWidget>
    with TickerProviderStateMixin {
  late MdONewCopyModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => MdONewCopyModel());
