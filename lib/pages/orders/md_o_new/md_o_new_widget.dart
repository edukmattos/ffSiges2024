...
import 'md_o_new_model.dart';
export 'md_o_new_model.dart';

class MdONewWidget extends StatefulWidget {
  const MdONewWidget({
    super.key,
  ...
  @override
  State<MdONewWidget> createState() => _MdONewWidgetState();
}

class _MdONewWidgetState extends State<MdONewWidget>
    with TickerProviderStateMixin {
  late MdONewModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => MdONewModel());
  ...
  Widget build(BuildContext context) {
    ...
    return FutureBuilder<List<VOrdersRow>>(
      ...
      builder: (context, snapshot) {
        ...
        List<VOrdersRow> orderNewVOrdersRowList = snapshot.data!;
        final orderNewVOrdersRow = orderNewVOrdersRowList.isNotEmpty
            ? orderNewVOrdersRowList.first
            : null;
        return Container(
                                                          ...
                                                          _model.resOrderAdded =
                                                            ...
                                                            'year':
                                                                orderNewVOrdersRow
                                                                    ?.year,
                                                            'orderMask':
                                                                '${orderNewVOrdersRow?.counterParent?.toString()}.${_model.lcsvOrderChildCounter?.toString()}.${orderNewVOrdersRow?.year?.toString()}',
                                                            'requesterDate':
                                                                supaSerialize<
                                                                        DateTime>(
                                                                    getCurrentTimestamp),
